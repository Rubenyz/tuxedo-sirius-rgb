#!/usr/bin/env python3
"""
TUXEDO Sirius RGB - PyQt6 GUI Editor
...
from manager import ColorConfigManager
...
class KeyItem(QGraphicsPathItem):
    ...
    def _center_text(self):
        ...
        text_x = (self._width - text_bounds.width()) / 2
        text_y = (self._height - text_bounds.height()) / 2
    ...
    def update_color(self):
        ...
        text_color = QColor('#5a5a5a') if luminance > 0.4 else QColor('#dddddd')
...
class KeyboardViewerGUI(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("TUXEDO Sirius RGB")
    ...
    def _show_how_to_use(self):
        dialog = QDialog(self)
        dialog.setWindowTitle("How to Use — TUXEDO Sirius RGB")
...
"""
    ...
    def _show_about(self):
        dialog = QDialog(self)
        dialog.setWindowTitle(f"About TUXEDO Sirius RGB v{__version__}")
        ...
        title = QLabel(f"TUXEDO Sirius RGB v{__version__}")
        title.setStyleSheet(
        ...
        subtitle = QLabel("Per-key RGB configurator for TUXEDO Sirius keyboards")
    ...
    def _setup_tray(self):
        ...
        self.tray_icon.setToolTip("TUXEDO Sirius RGB")
...
def main():
    ...
    app.setApplicationName("TUXEDO Sirius RGB")
